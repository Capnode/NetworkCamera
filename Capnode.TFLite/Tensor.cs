...
namespace Capnode.TFLite
{
    ...
    public class Tensor : UnmanagedObject
    {
        ...
        public DataType Type
        {
            get
            {
                return TfLiteInvoke.TensorGetType(_ptr);
            }
        }
        ...
        public IntPtr DataPointer
        {
            get
            {
                return TfLiteInvoke.TensorGetData(_ptr);
            }
        }
        ...
        public QuantizationParams QuantizationParams
        {
            get
            {
                ...
                TfLiteInvoke.TensorGetQuantizationParams(_ptr, ref p);
                return p;
            }
        }
        ...
        public AllocationType AllocationType
        {
            get
            {
                return TfLiteInvoke.TensorGetAllocationType(_ptr);
            }
        }
        ...
        public int ByteSize
        {
            get
            {
                return TfLiteInvoke.TensorGetByteSize(_ptr);
            }
        }
        ...
        public String Name
        {
            get
            {
                return Marshal.PtrToStringAnsi(TfLiteInvoke.TensorGetName(_ptr));
            }
        }
        ...
        public Array GetData(bool jagged = true)
        {
            ...
            TfLiteInvoke.Memcpy(handle.AddrOfPinnedObject(), DataPointer, byteSize);
            handle.Free();
            return array;
        }
        ...
        public int[] Dims
        {
            get
            {
                using (IntArray ia = new IntArray(TfLiteInvoke.TensorGetDims(_ptr), false))
                {
                    return ia.Data;
                }
            }
    ...
    public static partial class TfLiteInvoke
    {
        ...
        internal static extern DataType TensorGetType(IntPtr tensor);


        [DllImport(TfliteDll, CallingConvention = TfLiteInvoke.TFCallingConvention)]
        internal static extern IntPtr TensorGetData(IntPtr tensor);

        [DllImport(TfliteDll, CallingConvention = TfLiteInvoke.TFCallingConvention)]
        internal static extern void TensorGetQuantizationParams(IntPtr tensor, ref QuantizationParams p);

        [DllImport(TfliteDll, CallingConvention = TfLiteInvoke.TFCallingConvention)]
        internal static extern AllocationType TensorGetAllocationType(IntPtr tensor);

        [DllImport(TfliteDll, CallingConvention = TfLiteInvoke.TFCallingConvention)]
        internal static extern int TensorGetByteSize(IntPtr tensor);

        [DllImport(TfliteDll, CallingConvention = TfLiteInvoke.TFCallingConvention)]
        internal static extern IntPtr TensorGetName(IntPtr tensor);

        [DllImport(TfliteDll, CallingConvention = TfLiteInvoke.TFCallingConvention)]
        internal static extern IntPtr TensorGetDims(IntPtr tensor);
